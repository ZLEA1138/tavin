...
functions.cool_lava = function(pos, node)
	if node.name == "sb_core:lava_source" then
		minetest.set_node(pos, {name = "sb_core:obsidian"})
	else -- Lava flowing
		minetest.set_node(pos, {name = "sb_core:stone"})
	end
...
if minetest.settings:get_bool("enable_lavacooling") ~= false then
	minetest.register_abm({
		label = "Lava cooling",
		nodenames = {"sb_core:lava_source", "sb_core:lava_flowing"},
