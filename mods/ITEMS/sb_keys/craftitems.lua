...
minetest.register_craftitem("sb_keys:skeleton_keycard", {
	description = "Skeleton Keycard",
	...
	on_use = function(itemstack, user, pointed_thing)
		...
		if secret then
			...
			local new_stack = ItemStack("sb_keys:keycard")
			local meta = new_stack:get_meta()
			meta:set_string("secret", secret)
			meta:set_string("description", S("Keycard to @1's @2", user:get_player_name(),
