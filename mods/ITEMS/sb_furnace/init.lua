...
function sb_furnace.get_furnace_active_formspec(fuel_percent, item_percent)
	return "size[8,8.5]"..
		"list[context;src;2.75,0.5;1,1;]"..
		"list[context;fuel;2.75,2.5;1,1;]"..
		"image[2.75,1.5;1,1;furnace_fire_bg.png^[lowpart:"..
		(fuel_percent)..":furnace_fire_fg.png]"..
		"image[3.75,1.5;1,1;furnace_arrow_bg.png^[lowpart:"..
		(item_percent)..":furnace_arrow_fg.png^[transformR270]"..
		...
		"listring[current_player;main]"..
		inventory.get_hotbar_bg(0, 4.25)
end

function sb_furnace.get_furnace_inactive_formspec()
	return "size[8,8.5]"..
		"list[context;src;2.75,0.5;1,1;]"..
		"list[context;fuel;2.75,2.5;1,1;]"..
		"image[2.75,1.5;1,1;furnace_fire_bg.png]"..
		"image[3.75,1.5;1,1;furnace_arrow_bg.png^[transformR270]"..
		"list[context;dst;4.75,0.96;2,2;]"..
		"list[current_player;main;0,4.25;8,1;]"..
		"list[current_player;main;0,5.5;8,3;8]"..
		"listring[context;dst]"..
...
local function furnace_node_timer(pos, elapsed)
	...
	if fuel_totaltime ~= 0 then
		...
		formspec = sb_furnace.get_furnace_active_formspec(fuel_percent, item_percent)
		swap_node(pos, "sb_furnace:furnace_active")
		-- make sure timer restarts automatically
		result = true

		-- Play sound every 5 seconds while the furnace is active
		if timer_elapsed == 0 or (timer_elapsed + 1) % 5 == 0 then
			local sound_id = minetest.sound_play("furnace_active",
		...
		formspec = sb_furnace.get_furnace_inactive_formspec()
		swap_node(pos, "sb_furnace:furnace")
...
local function apply_logger(def)
	functions.set_inventory_action_loggers(def, "furnace")
	return def
end

minetest.register_node("sb_furnace:furnace", apply_logger({
	description = "Furnace",
	tiles = {
	...
	on_blast = function(pos)
		local drops = {}
		functions.get_inventory_drops(pos, "src", drops)
		functions.get_inventory_drops(pos, "fuel", drops)
		functions.get_inventory_drops(pos, "dst", drops)
		drops[#drops+1] = "sb_furnace:furnace"
